...
define("components/SwapBoard", ["require", "exports", "react", "util/math", "store/store"], function (require, exports, React, math_1, store_1) {
    "use strict";
    function match(a, b) {
    ...
    var SwapBoard = (function (_super) {
        ...
        SwapBoard.prototype.createBoard = function (props) {
            ...
            var _loop_2 = function() {
                ...
                if (store_1.getProgress(cur.flashcard.stack, cur.flashcard.text) >= 50 && Math.random() > 0.33)
                    return "continue";
...
define("components/StackSelect", ["require", "exports", "react", "store/store"], function (require, exports, React, store_2) {
    "use strict";
    /**
    ...
    var StackCard = (function (_super) {
        ...
        StackCard.prototype.render = function () {
            ...
            var confidence = (this.props.cards.map(function (c) { return store_2.getProgress(_this.props.stackName, c.text); }).reduce(function (sum, p) { return sum + p; }) / this.props.cards.length).toFixed(1);
...
define("components/GameOver", ["require", "exports", "react", "store/store"], function (require, exports, React, store_3) {
    "use strict";
    var GameOver = (function (_super) {
        ...
        GameOver.prototype.stats = function () {
            ...
            return Object.keys(progress).map(function (p) { return progress[p]; }).sort(function (a, b) { return store_3.getProgress(a.stack, a.text) - store_3.getProgress(b.stack, b.text); }).map(function (p) {
                var now = Math.min(100, store_3.getProgress(p.stack, p.text));
                var before = Math.max(0, now - p.progress);
                var value = _this.state.showBefore ? before : now;
                var style = {
                    width: value + "%",
                    backgroundColor: _this.progressToColor(value)
                };
                return React.createElement("div", {className: "stat"}, React.createElement("label", null, p.text), React.createElement("div", {className: "progress"}, React.createElement("div", {className: "progress-bar"}, React.createElement("span", {className: "percent"}, value, "%"), React.createElement("div", {className: "bar", style: style}))));
            });
        };
...
define("app", ["require", "exports", "react", "react-dom", "components/SwapBoard", "store/store", "components/StackSelect", "util/math", "components/GameOver", "buzz"], function (require, exports, React, ReactDOM, SwapBoard_1, store_4, StackSelect_1, math_2, GameOver_1, buzz) {
    "use strict";
    var sounds = {
    ...
    var App = (function (_super) {
        ...
        App.prototype.onFinished = function () {
            ...
            for (var key in progressed) {
                ...
                var progress = Math.max(0, Math.min(100, store_4.getProgress(entry.stack, entry.text) + entry.progress));
                update.push({ stackName: entry.stack, cardText: entry.text, progress: progress });
            }
            store_4.updateProgress(update);
            this.setState({
        ...
        App.prototype.onPlayAgain = function () {
            ...
            setTimeout(function () {
                _this.onStart(store_4.getStore().selectedStacks);
            }, 300);
        };
        App.prototype.onStart = function (selectedStacks) {
            ...
            var sorted = pool.sort(function (a, b) {
                var progressA = store_4.getProgress(a.stack, a.text);
                var progressB = store_4.getProgress(b.stack, b.text);
        ...
        App.prototype.onStackSelection = function (stackName, selected) {
            ...
            if (selectedStacks.length > 0) {
                store_4.updateStore({ selectedStacks: selectedStacks });
                store_4.persist();
            }
        };
        return App;
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = App;
    store_4.onStoreChanged(function (update) {
